...
$filename = $email_id.$extension;

//echo $filename;
if (file_exists("uploads/" . $filename)) {
//echo '<a href="uploadpic.php" >';
echo '<div class="image"> ';
echo '<img src="uploads/'.$email_id.'.jpg" alt="face" height= " 142 " width= " 142 " />';
echo '</a></div>'; }
else
{
//echo '<a href="uploadpic.php" >';
...
$query="select * from profile where email_id='".$email_id."'";
...
$query2="select * from signup where email_id='".$email_id."'";
